...
\begin{DoxyItemize}
\item PLL output frequency = ((HSE frequency \texorpdfstring{$\ast$}{*} PLLMul) /\+ PLLDiv)
\item PLLMul:\+ The application software must set correctly the PLL multiplication factor to to ensure
\begin{DoxyItemize}
\item PLLVCO does not exceed 96 MHz when the product is in range 1,
\item PLLVCO does not exceed 48 MHz when the product is in range 2,
\item PLLVCO does not exceed 24 MHz when the product is in range 3 
\end{DoxyItemize}
\end{DoxyItemize}
...
{\em HSEFrequency} & Value between Min\+\_\+\+Data = 1000000 and Max\+\_\+\+Data = 24000000 \\
\hline
...
Function is based on the following formula:\+
\begin{DoxyItemize}
\item PLL output frequency = ((HSI frequency \texorpdfstring{$\ast$}{*} PLLMul) /\+ PLLDiv)
\item PLLMul:\+ The application software must set correctly the PLL multiplication factor to ensure
\begin{DoxyItemize}
\item PLLVCO does not exceed 96 MHz when the product is in range 1,
\item PLLVCO does not exceed 48 MHz when the product is in range 2,
\item PLLVCO does not exceed 24 MHz when the product is in range 3 
...
Error\+Status LL\+\_\+\+Set\+Flash\+Latency (\begin{DoxyParamCaption}\item[{uint32\+\_\+t}]{Frequency}{}\end{DoxyParamCaption})}
